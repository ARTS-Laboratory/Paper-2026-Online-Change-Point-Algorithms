...
def profile_memory_for_algs():
    """ """
    print(f'Memory profile for bocpd python.')
    profile_bocpd_from_python()
    print(f'Memory profile for bocpd rust.')
    profile_bocpd_from_rust()
    print(f'Memory profile for cusum v0.')
    profile_cusum_alg()
    print(f'Memory profile for cusum v0 using deques.')
    profile_cusum_alg_v1()
    print(f'Memory profile for expectation maximization.')
    profile_em_from_python()
    print(f'Memory profile for grey systems model.')
    profile_grey_model_from_python()
    print(f'Memory profile for isolation forest.')

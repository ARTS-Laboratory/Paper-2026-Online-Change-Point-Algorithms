...
impl BetaCache {
    ...
    pub fn get_value(&mut self, value: f64) -> f64 {
        ...
        //     let &value = e.get();
        //     value
        // } else if let std::collections::hash_map::Entry::Occupied(mut e) = self.cache.entry((value - 1.0).to_bits()) {
        //     let &beta_val = e.get();
        //     let fixed = self.fixed_value;
        //     let res = (value / (fixed + value)) * beta_val;
        //     e.insert(res);
        //     res
        // } else {
        //     let fixed = self.fixed_value;
        ...
        //         _ => todo!("add functionality for other float types."),
        //     };
        //     self.cache.insert(res.to_bits(), res);
        //     res
        // }
    }
}
